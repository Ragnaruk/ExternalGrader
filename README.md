...
## Тестирование
В директории `/tests/` находятся тесты, сделанные с помощью библиотеки PyTest.

Тесты автоматически выполняются при каждом коммите в этот репозиторий.
Статус тестов и покрытие ими есть в шапке этого файла.
...
# Тестирование с указанием покрытия тестами
make test-cov
```
